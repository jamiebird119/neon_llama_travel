"""
Django settings for neon_llama project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tours.contexts.geography',
                'tours.contexts.category'
            ],
        },
    },
]
...
WSGI_APPLICATION = 'neon_llama.wsgi.application'
